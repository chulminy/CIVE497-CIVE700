...
**(b)** Compute a Fourier transform of the triangular function in both analytic and numeric ways:
...
![](https://latex.codecogs.com/gif.latex?y1%20%3D%20e%5E%7B-a%7Ct%7C%7D%20%28b*cos%7B2%20%5Cpi%20f_1%20t%7D%20&plus;%20c*cos%7B2%20%5Cpi%20f_2%20t%7D%20%29) &nbsp;&nbsp;&nbsp;&nbsp; where a = 2, b = 2, c= 6, f<sub>1</sub> = 3, and f<sub>2</sub> = 6 


![](https://latex.codecogs.com/gif.latex?y2%20%3D%20e%5E%7B-a%7Ct%7C%7D%20%28b*cos%7B2%20%5Cpi%20f_1%20t%7D%20&plus;%20c*cos%7B2%20%5Cpi%20f_2%20t%7D%20%29) &nbsp;&nbsp;&nbsp;&nbsp; where a = 0.3, b = 10, c= 3, f<sub>1</sub> = 5, and f<sub>2</sub> = 8 
...
**(c)** Please compare the shape of the frequency curves of z1 and z2. Which frequency curve is thinner (more narrow)? For example, compare the frequency curve at 3 Hz in (b) and 5 Hz in (d). which one is thinner? Please explain your answer. What makes this difference? 
...
**(e)** If you digitize a longer-duration signal (let's say 20 seconds), can you measure and extract all frequencies in the original signal, y(t)? Please explain your answer. 

**(f)** If you digitize the signal with a sampling rate of 105 Hz, can you measure and extract all frequencies in the original signal, y(t)? please explain your answer.

**(g)** If you digitize the signal with a sampling rate of 251 Hz, can you measure and extract all frequencies in the original signal, y(t)? please explain your answer.

## Problem 7: Frequency Analysis (10 points)
Two sinusoidal accelerations are measured using a accelerometer in a smartphone. Each of the waves are stored at `vib_data1.mat` and `vib_data2.mat`. 
