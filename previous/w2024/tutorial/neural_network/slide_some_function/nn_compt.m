...
-2*(0.01-0.6352)
logi_fun(0.5546)*logi_fun(-0.5546)

0.4*logi_fun(0.3775)*logi_fun(-0.3775)*0.05
0.5*logi_fun(0.3775)*logi_fun(-0.3775)*0.05

-2*(0.01-0.6352)*logi_fun(0.5546)*logi_fun(-0.5546)*0.0048 -2*(0.99-0.6723)*logi_fun(0.7188)*logi_fun(-0.7188)*0.006
