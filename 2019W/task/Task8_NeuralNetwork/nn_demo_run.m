...
net.output.loss = 'binary_cross_entropy';

end

function test_nn_dataset(net, dataset)
...
ind_set1 = ind_set1(1:min(numel(ind_set1), grid_info.numPt_plot));
ind_set2 = ind_set2(1:min(numel(ind_set2), grid_info.numPt_plot));
