...
Marked reports will be distributed via email and a possible solution for tasks may be reviewed in class with the instructor and a couple of the best reports in each task will be posted on the class web page with the consent of the corresponding students. 
